...
<c:catch var="exception">
    ...
    <div class="form-custom">
      <h4 class="fw-bold text-dark p-2 bg-light rounded text-white">
        <i class="fa-solid fa-umbrella" title="misura di prevenzione"></i>&nbsp; 
        <c:out value="${meas.nome}" />
      </h4>
      <hr class="separatore" />
      <h4 class="fw-bold text-dark border-bottom border-2 border-secondary p-2">
        ...
        Rischi a cui questa misura &egrave; applicata
      </h4>
      ...
      <ul class="line bgcolor-minimo">
        <li class="line">&nbsp;&nbsp; <i class="fa-solid fa-umbrella" title="misura di prevenzione"></i>&nbsp; Tipologia 1</li>
        <li class="line">&nbsp;&nbsp; <i class="fa-solid fa-umbrella" title="misura di prevenzione"></i>&nbsp; Tipologia 2</li>
        <li class="line">&nbsp;&nbsp; <i class="fa-solid fa-umbrella" title="misura di prevenzione"></i>&nbsp; Tipologia 3</li>
      </ul>
      ...
      <section>
        ...
        <ul class="line">
          <li class="line">Capofila 1</li>
          <li class="line">Capofila 2</li>
          <li class="line">Capofila 3</li>
        </ul>
      </section>
      ...
      <section>
        <h4 class="fw-bold text-dark border-bottom border-2 border-secondary p-2">
          <i class="fa-solid fa-building-circle-check ico-home"></i>&nbsp; Strutture Gregarie
        </h4>
        <ul class="line">
          <li class="line">&nbsp;&nbsp; <i class="fa-solid fa-umbrella" title="misura di prevenzione"></i>&nbsp; Struttura 1</li>
          <li class="line">&nbsp;&nbsp; <i class="fa-solid fa-umbrella" title="misura di prevenzione"></i>&nbsp; Struttura 2</li>
          <li class="line">&nbsp;&nbsp; <i class="fa-solid fa-umbrella" title="misura di prevenzione"></i>&nbsp; Struttura 3</li>
        </ul>
      </section>
      ...
      <section>
        <h4 class="fw-bold text-dark border-bottom border-2 border-secondary p-2">
          <i class="fa-solid fa-circle-info ico-home"></i>&nbsp; Altre informazioni
        </h4>
