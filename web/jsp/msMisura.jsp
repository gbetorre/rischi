...
<c:catch var="exception">
    ...
    <div class="form-custom bgAct27">
      ...
      <h4 class="fw-bold text-dark border-bottom border-2 border-secondary p-2">
        ...
        Rischi ai quali questa misura &egrave; applicata
      </h4>
        ...
        <c:forEach var="cp" items="${meas.capofila}" varStatus="innerStatus">
          <c:if test="${innerStatus.count eq meas.capofila.size()}">
            <li class="line">
              ...
              <span class="badge badge-pill bg-primary btn-small lightTable marginLeft">CAPOFILA</span>
            </li>
          </c:if>
        </c:forEach>
        <c:forEach var="cp2" items="${meas.capofila2}" varStatus="innerStatus">
          <c:if test="${innerStatus.count eq meas.capofila2.size()}">
            <li class="line">
              ...
              <span class="badge badge-pill bg-warning text-black btn-small lightTable marginLeft">CAPOFILA 2</span>
            </li>
          </c:if>
        </c:forEach>
        <c:forEach var="cp3" items="${meas.capofila3}" varStatus="innerStatus">
          <c:if test="${innerStatus.count eq meas.capofila3.size()}">
            <li class="line">
              ...
              <span class="badge badge-pill bg-info btn-small lightTable marginLeft">CAPOFILA 3</span>
            </li>
          </c:if>
        </c:forEach>
        </ul>
