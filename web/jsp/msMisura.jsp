      ...
      <div class="content-holder bgAct">
        <dl class="sezioneElenco custom-dl marginBottom">
          ...
          <c:choose> 
            ...
            <c:otherwise>
            <a href="${initParam.appName}/?q=ic&p=add&mliv=${meas.codice}&r=${param['r']}#details" class="badge bg-danger btn-small lightTable text-white  align-middle refresh" title="Aggiungi dettagli monitoraggio">
              <strong><i class="fa-solid fa-square-plus"></i> Dettagli</strong>
            </a>&nbsp;
            </c:otherwise>
          </c:choose>
          </dd>
