...
<c:catch var="exception">
  ...
  <c:if test="${not empty input}">
    ...
    <div class="subfields ">Area di rischio: <span class="file-data"><c:out value="${arearischio}" /></span></div>
    ...
    <table class="table table-striped risultati" id="foundPerson">
      <thead>
        <tr>
          <th class="Content_Medio" width="5%" align="center">N. </th>
          <th class="Content_Medio" width="55%" align="center">Fase </th>
          <th class="Content_Medio" width="40%" align="center">Struttura <small>e/o</small> Soggetto interessato </th>
        </tr>
      </thead>
