        ...
        <div class="panel-body">
          <div class="row"> 
            <div class="content-holder col-sm-10 bg-note">
              ...
              <c:if test="${empty subjects}">NESSUNO</c:if>
              <ul>
          ...
          <div class="content-holder col-sm-10">
            <div class="fas-container">
              <div class="reportRow bgAct31">&nbsp;&nbsp;Inserimento nuovo soggetto</div>
              <hr class="separapoco" />
              <div id="callable-row">
                <div class="row">
                  <div class="col-12 large-4">
                    <input type="text" class="form-control sIno" id="ou-nuovo" name="ou-newn" placeholder="Inserisci nome soggetto">
