...
<c:if test="${not empty meas.dataScadenza}">
  <fmt:formatDate var="expires" value="${meas.dataScadenza}" pattern="dd/MM/yyyy" />
</c:if>
<c:catch var="exception">
    ...
    <div class="form-custom bgAct28">
      <form accept-charset="ISO-8859-1" id="upm-form" class="errorPwd" action="" method="post">
        <div class="content-holder bgAct">
          <dl class="sezioneElenco custom-dl marginBottom">
            <dt class="text-primary">Carattere</dt>
            <dd class="marginLeftSmall"><strong><c:out value="${meas.carattere.nome}" /></strong></dd>
            <dt class="text-primary">Comporta Spese?</dt>
            <dd class="marginLeftSmall"><strong><c:out value="${fn:toUpperCase(meas.getOnerosa(meas.onerosa))}" /></strong></dd>
            <dt class="text-primary">Codice</dt>
            <dd class="marginLeftSmall"><strong><c:out value="${meas.codice}" /></strong></dd>
            <dt class="text-primary">Monitorata</dt>
            <dd class="marginLeftSmall">
              <strong><c:out value="${dets}" />&nbsp;</strong>
            </dd>
            <dt class="text-primary">Scadenza</dt>
            <dd>
              <div class="col-sm-3">
                <input type="text" class="calendarData" id="ms-data" name="ms-data" value="<fmt:formatDate value="${meas.dataScadenza}" pattern="dd/MM/yyyy" />" placeholder="${expires}">
              </div>
            </dd>
            <dt>&nbsp;</dt>
            <dd class="marginLeftSmall">
    ...
    $('#upm-form').validate ({
        ...
        messages: {
          'ms-data': "Inserire la data di scadenza della misura"
        },
